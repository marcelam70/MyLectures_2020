...
public class Sel_39_TestNG {
	...
	public void getTitle() {
		...
		Assert.assertEquals(title, "HubSpot Login"); //verification in testNG
	}
	
	 @Test(priority=2, description="Login system using invalid username invalid pass")
	 public void invalidCredentials() {
	   getElement(driver, email).sendKeys("jake@sample.com");
	   getElement(driver, password).sendKeys("mimoso123");
